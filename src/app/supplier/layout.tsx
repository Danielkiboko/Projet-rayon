    ...
    <div className="flex h-screen bg-[#0b061c] overflow-hidden">
      ...
      >
        <div className="h-16 flex items-center justify-between px-6 border-b border-white/10">
          <span className="text-xl font-bold text-white tracking-wider">Fournisseur<span className="text-primary-light">.</span></span>
      ...
      <main className="flex-1 flex flex-col h-screen overflow-hidden">
        <header className="h-16 flex items-center justify-between px-6 border-b border-white/10 bg-[#140b2e]/50 backdrop-blur-md lg:hidden">
          ...
          <span className="text-xl font-bold text-white">Espace Fournisseur</span>
