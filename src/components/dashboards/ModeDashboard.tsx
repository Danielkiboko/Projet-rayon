...
export default function ModeDashboard() {
  ...
  if (loading) {
    return <div className="text-white animate-pulse">Chargement de votre boutique...</div>;
  }
    ...
    <div className="space-y-6">
        ...
        {KPIS.map((kpi, idx) => {
          ...
          return (
            <motion.div
              ...
              className="bg-[#1a1a1a] border border-white/5 rounded-2xl p-5 flex flex-col justify-between h-32 hover:border-blue-500/10 transition-colors shadow-sm relative overflow-hidden group"
            >
              ...
              <div className="flex justify-between items-start relative z-10">
                ...
                <Icon size={16} className={kpi.title === "À Expédier" && stats.pendingDeliveries > 0 ? "text-orange-500" : "text-blue-500"} />
              </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          <RevenueAreaChart data={revenueData} title="Évolution des Ventes (30 j)" color="#3b82f6" />
        ...
        <div className="space-y-6">
          ...
          >
            ...
            <h2 className="text-base font-semibold text-white mb-4 text-center relative z-10">Gérer ma boutique</h2>
            
            <div className="relative z-10 bg-white/5 rounded-xl p-4 border border-white/5 hover:border-blue-500/20 transition-colors mb-4 cursor-pointer" onClick={() => window.location.href='/supplier/products'}>
              <h3 className="text-sm font-semibold text-white mb-2">Ajouter un produit</h3>
              <p className="text-xs text-gray-400 mb-4 leading-relaxed">
                Mettez en vente de nouveaux articles dans votre catalogue e-commerce.
              </p>
            ...
            <div className="relative z-10 bg-white/5 rounded-xl p-4 border border-white/5 hover:border-blue-500/20 transition-colors cursor-pointer" onClick={() => window.location.href='/supplier/orders'}>
